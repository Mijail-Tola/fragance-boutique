                ...
                {items.map((item) => (
                  <div key={item.id} className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center border-b border-gray-50 pb-6 last:border-0 last:pb-0">
                    ...
                    <div className="col-span-1 md:col-span-6 flex items-center gap-4">
                      ...
                      <button onClick={() => removeItem(item.id)} className="text-gray-400 hover:text-[#e3000f] transition-colors p-2 shrink-0">
                    ...
                    <div className="col-span-1 md:col-span-2 flex justify-start md:justify-center">
                      {!mostrarQR ? (
                        <div className="flex items-center border border-black rounded-sm overflow-hidden">
                          ...
                          <span className="w-10 text-center text-sm font-bold text-gray-900 border-x border-black py-1">{item.cantidad}</span>
